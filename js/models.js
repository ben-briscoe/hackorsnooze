...
class User {
  ...
  static async removeFavorite(currentUser,id) {
    await axios.delete(`https://hack-or-snooze-v3.herokuapp.com/users/${currentUser.username}/favorites/${id}`,{params:{token:currentUser.loginToken}})
  }

  static async removeStory(currentUser,id){
